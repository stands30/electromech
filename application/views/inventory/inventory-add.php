...
<html lang="en">
  ...
  <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
    ...
    <div class="page-container">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group form-md-line-input form-md-floating-label">
                          ...
                          <div class="input-icon">
                            <input type="text" class="form-control piv_date " required="" data-msg="Please Select Date" id="piv_date" name="piv_date"  readonly="">
                                  ...
                                  <div class="row product_repeater_item" data-repeater-item="product_repeater_item"  >
                                    ...
                                    <?php } ?>
                                       <div class="col-md-2">
                                        <div class="form-group form-md-line-input form-md-floating-label">
                                            <div class="input-icon input-label-text">
                                              <input type="text" name="piv_price"  value="" class="form-control repeater-text  color-primary-light prod_price numeric-decimal-format" required="">
                                      ...
                                      <div class="col-md-2">
                                        <div class="form-group form-md-line-input form-md-floating-label">
                                            <div class="input-icon input-label-text">
                                              <input type="text" name="piv_qty" value="" class="form-control repeater-text  color-primary-light prod_qty numeric-format"  required="">
                                              <label  class="repeater-label" for="piv_qty">Quantity <span class="asterix-error"><em>*</em></span></label>
      ...
      <script src="<?php echo base_url(); ?>assets/module/inventory/inventory_form.js<?php echo $global_asset_version; ?>" type="text/javascript"></script>
        <!-- OPTIONAL SCRIPTS -->
