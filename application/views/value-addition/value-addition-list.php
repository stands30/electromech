                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <div  id="btn-box" class="btn-group">
                                        ...
                                        <a id="sample_editable_1_new" href="<?php echo base_url('value-addition-add'); ?>" class="btn green"> Add Value Addition
                            ...
                            <div class="portlet-body">
                                <table class="table table-striped table-bordered table-hover table-quot table-list" id="module-list">
                                    <thead>
                                        <tr>
                                            <th><i class="fas fa-handshake icon-client list-level"></i>Value Addition Name</th>
                                            <th><i class="fas fa-handshake icon-client list-level"></i>Type</th>
                                    ...
                                    <tbody>
                                      <tr>
                                          <td><a href="<?php echo base_url('value-addition-details'); ?>">Sales Process</a></td>
                                          <td>Workshop</td>                                             
