                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <div  id="btn-box" class="btn-group">
                                        ...
                                        <a id="sample_editable_1_new" href="<?php echo base_url('notice-board-add'); ?>" class="btn green"> Add Notice Board
                            ...
                            <div class="portlet-body">
                                <table class="table table-striped table-bordered table-hover table-quot table-list" id="module-list">
                                    <thead>
                                        <tr>
                                            <th><i class="fab fa-flipboard pie-color list-level"></i>What's on your mind ?</th>
                                            <!-- <th><i class="fas fa-globe list-level"></i>Link</th> -->
                                            <th><i class="far fa-calendar-alt list-level"></i>Created By</th>           
                                    ...
                                    <tbody>
                                      <tr>
                                          <td>How to work smarter</td>
                                          <!-- <td><a href="https://www.inc.com/john-rampton/work-smarter-not-harder-10-ways-to-be-more-effective-at-work.html" target="_blank">https://www.inc.com/john-rampton/work-smarter-not-harder-10-ways-to-be-more-effective-at-work.html</a></td> -->
                                          <td>Amit Roy</td>
