                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-quot table-list" id="module-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Easy Now Pro</td>
                                                <td><a href="<?php echo base_url('product-invoice-report-80-20'); ?>" class="table-highlighted-link"><b>500</b></a></td>                                                               
                                            </tr>
                                            <tr>
                                                <td>Easy Now</td>
                                                <td><a href="<?php echo base_url('product-invoice-report-80-20'); ?>" class="table-highlighted-link"><b>400</b></a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
