                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold">Team Sales</span> &nbsp;
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-quot table-list" id="module-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Developer</td>
                                                <td><a href="<?php echo base_url('team-invoice-report-80-20'); ?>" class="table-highlighted-link"><b>50,000</b></a></td>                                                               
                                            </tr>
                                            <tr>
                                                <td>Testing</td>
                                                <td><a href="<?php echo base_url('team-invoice-report-80-20'); ?>" class="table-highlighted-link"><b>40,000</b></a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
