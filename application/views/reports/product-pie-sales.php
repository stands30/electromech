                          ...
                          <div class="portlet light bordered">
                            <div class="portlet-title">
                              <div class="caption font-dark">
                                ...
                                <span class="caption-subject  bold">Top 5 Product Pie Sales
                                </span> &nbsp;
                              </div>
                            </div>
                        ...
                        <div class="col-md-12">
                          <div class="portlet light bordered">
                            <div class="portlet-title">
                              <div class="caption font-dark">
                                <!-- <i class="icon-settings font-dark"></i> -->
                                <span class="caption-subject  bold">Product Pie Sales
                                </span> &nbsp;
                              </div>
                            </div>
        ...
        <div class="js-scripts">
          ...
          <script src="<?php echo base_url(); ?>assets/project/sweetalert/dist/sweetalert.min.js<?php echo $global_asset_version; ?>" type="text/javascript"></script>
            <script>
              ...
              var chart = am4core.create("product-pie-chart", am4charts.PieChart3D);
