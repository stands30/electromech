                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold">Customer Sales Invoice</span> &nbsp;
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-quot table-list" id="module-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Tripfeber</td>
                                                <td><a href="#" class="table-highlighted-link"><b>IO12345</b></a></td>  
                                                <td>5th January 2019</td>                                                        
                                                <td>5,000</td>
                                            </tr>
                                            <tr>
                                                <td>ITI</td>
                                                <td><a href="#" class="table-highlighted-link"><b>IO34546</b></a></td>
