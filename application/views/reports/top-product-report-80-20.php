                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-quot table-list" id="module-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Website</td>
                                                <td><a href="<?php echo base_url('product-invoice-report-80-20'); ?>" class="table-highlighted-link"><b>10,00,870</b></a></td>                                                               
                                            </tr>
                                            <tr>
                                                <td>ERP</td>
                                                <td><a href="<?php echo base_url('product-invoice-report-80-20'); ?>" class="table-highlighted-link"><b>8,00,870</b></a></td>
                                            </tr>
                                            <tr>
                                                <td>CRM</td>
                                                <td><a href="<?php echo base_url('product-invoice-report-80-20'); ?>" class="table-highlighted-link"><b>6,40,870</b></a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
