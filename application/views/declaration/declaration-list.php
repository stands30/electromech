                    ...
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <div  id="btn-box" class="btn-group">
                                        ...
                                        <a id="sample_editable_1_new" href="<?php echo base_url('declaration-add'); ?>" class="btn green"> Add Declaration
                            ...
                            <div class="portlet-body">
                                <table class="table table-striped table-bordered table-hover table-quot table-list" id="module-list">
                                    <thead>
                                        <tr>
                                            <th><i class="fas fa-bullseye list-level"></i>Mission</th>
                                            <th><i class="fas fa-eye list-level"></i>Vision</th>
                                    ...
                                    <tbody>
                                      <tr>
                                          <td><a href="<?php echo base_url('declaration-details'); ?>">Better health and wellbeing for all Indians, now and for future generations.</a></td>
                                          <td><a href="<?php echo base_url('declaration-details'); ?>">To create a better everyday life for the many people.</a></td>                                              
                                          <td>Sonal</td>
