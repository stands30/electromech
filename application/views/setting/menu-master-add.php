            ...
            <div class="row">
              ...
              <div class="container-fluid">
                <div class="text-center title_wrap">
                  <h3 class="page-title text-center">Add New Menu Master
                  </h3>
                  <span class="sp_line color-primary">
                  </span>
                </div>
                <form role="form" class="col-md-push-2 col-md-8 form_add" id="mnu_add">
                  <div class="form-group col-md-6">
                    <label>Name<span class="asterix-error"><em>*</em></span>
                    </label>
                    <input type="text" name="mnu_name" id="mnu_name" value="" class="form-control color-primary-light" placeholder="Name" required>
                  </div>
                  <div class="form-group col-md-6">
                    <label>Link<span class="asterix-error"><em>*</em></span>
                    </label>
                    <input type="text" name="mnu_link" id="mnu_link" value="" class="form-control color-primary-light" placeholder="Link" required>
                  </div>
                  <div class="form-group col-md-6">
                    <label>Icon<span class="asterix-error"><em>*</em></span>
                    </label>
                    <input type="text" name="mnu_icon" id="mnu_icon" value="" class="form-control color-primary-light" placeholder="Icon" required>
                  </div>
                  <div class="form-group col-md-6">
                    <label>Order<span class="asterix-error"><em>*</em></span>
                    </label>
                    <input type="text" name="mnu_order" id="mnu_order" value="" class="form-control color-primary-light" placeholder="Order" required>
                  </div>
                  <div class="form-group col-md-6">
