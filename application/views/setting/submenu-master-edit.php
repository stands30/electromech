            ...
            <div class="row">
              ...
              <div class="container-fluid">
                <div class="text-center title_wrap">
                  <h3 class="page-title text-center">Edit Submenu Master
                  </h3>
                  <span class="sp_line color-primary">
                  </span>
                </div>
                <form role="form" class="col-md-push-2 col-md-8 form_add" id="sub_menu_edit">
                  <div class="form-group col-md-6">
                    ...
                    <select name="sbm_mnu_id" id="sbm_mnu_id" class="form-control mnu_list" required>
                      <?php if(isset($sbm_details->sbm_mnu_id) and !empty($sbm_details->sbm_mnu_id)){ ?>
                        <option value="<?php echo $sbm_details->sbm_mnu_id ?>"><?php echo $sbm_details->mnu_name ?></option>
                      <?php } ?>
                    </select>
                  </div>
                  <div class="form-group col-md-6">
                    ...
                    <select name="sbm_parent_id" id="sbm_parent_id" class="form-control sub_mnu_list" >
                      <?php if(isset($sbm_details->sbm_parent_id) and !empty($sbm_details->sbm_parent_id)){ ?>
                        <option value="<?php echo $sbm_details->sbm_parent_id ?>"><?php echo $sbm_details->submnu_name ?></option>
                      <?php } ?>
                    </select>
                  </div>
                  <div class="form-group col-md-6">
                    ...
                    <input type="hidden" name="sbm_id" id="sbm_id"  value="<?php echo $sbm_details->sbm_id ?>">
                    <input type="text" name="sbm_name" id="sbm_name" value="<?php echo $sbm_details->sbm_name ?>" class="form-control color-primary-light" placeholder="Name" required>
                  </div>
                  <div class="form-group col-md-6">
                    <label>Link<span class="asterix-error"><em>*</em></span>
                    </label>
                    <input type="text" name="sbm_link" id="sbm_link" value="<?php echo $sbm_details->sbm_link ?>" class="form-control color-primary-light" placeholder="Link" required>
                  </div>
                  <div class="form-group col-md-6">
                    <label>Icon
                    </label>
                    <input type="text" name="sbm_icon" id="sbm_icon" value="<?php echo $sbm_details->sbm_icon ?>" class="form-control color-primary-light" placeholder="Icon">
                  </div>
                  <div class="form-group col-md-6">
                    <label>Order<span class="asterix-error"><em>*</em></span>
                    </label>
                    <input type="number" name="sbm_order" id="sbm_order" value="<?php echo $sbm_details->sbm_order ?>" class="form-control color-primary-light" placeholder="Order" required>
                  </div>
                  <div class="form-group col-md-6">
                    ...
                    <select name="sbm_status" id="sbm_status" class="form-control mnu_status" required>
                      <?php if(isset($sbm_details->sbm_status) and !empty($sbm_details->sbm_status)){ ?>
                        <option value="<?php echo $sbm_details->sbm_status ?>"><?php echo $sbm_details->sbm_status_name ?></option>
                      <?php } ?>
                    </select>
                    </div>
                  </div>
