...
<html lang="en">
  ...
  <head>
    ...
    <link href="<?php echo base_url(); ?>assets/lead/assets/css/lead-customs.css<?php echo $global_asset_version; ?>" rel="stylesheet" type="text/css" />
  </head>
              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 blue" href="<?php echo base_url('lead-list'); ?>">
                      <div class="visual">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 red" href="<?php echo base_url('lead-list'); ?>">
                      <div class="visual">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 green" href="<?php echo base_url('lead-list'); ?>">
                      <div class="visual">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 purple" href="<?php echo base_url('lead-list'); ?>">
                      <div class="visual">
                        <i class="fa fa-globe">
                        </i>
                      </div>
