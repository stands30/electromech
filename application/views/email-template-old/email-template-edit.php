                ...
                <form role="form" id="email_temp_edit" class="col-md-push-1 col-md-10 form_add">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group form-md-line-input form-md-floating-label">
                        <div class="input-icon">                            
                            <input type="text" name="emt_subject" id="emt_subject" class="form-control" value="<?php if(isset($emailTemp_data->emt_subject) and !empty($emailTemp_data->emt_subject)) echo $emailTemp_data->emt_subject ?>" data-msg="PLease enter subject" required placeholder=" ">
                   ...
                   <div class="row">
                    <div class="col-md-6">
                      <div class="form-group form-md-line-input form-md-floating-label">
                        <div class="input-icon">                            
                            <input type="email" name="emt_cc" id="emt_cc" value="<?php if(isset($emailTemp_data->emt_cc) and !empty($emailTemp_data->emt_cc)) echo $emailTemp_data->emt_cc ?>" class="form-control" placeholder="">
                            <label>CC</label>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group form-md-line-input form-md-floating-label">
                        <div class="input-icon">                          
                          <input type="email" name="emt_reply_to" id="emt_reply_to" class="form-control" value="<?php if(isset($emailTemp_data->emt_reply_to) and !empty($emailTemp_data->emt_reply_to)) echo $emailTemp_data->emt_reply_to ?>" placeholder="">
