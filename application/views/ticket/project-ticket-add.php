                                ...
                                <div class="form-body">
                                  <div class="row">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label class="control-label">Project<span class="asterix-error"><em>*</em></span></label>
                                          <select class="form-control select2">
                                               <option>Dr Patkar</option>
                                             <option>Oralcare</option>
                                             <option>Video Edit Hub</option>
                                          </select>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                        <div class="form-group">
                                          <label class="control-label">Visibility for Client<span class="asterix-error"><em>*</em></span></label>
                                          <select class="form-control select2">
                                            <option>Yes</option>
                                            <option>No</option>
                                       ...
                                       <div class="col-md-6">
                                        <div class="form-group">
                                          <label class="control-label">Due Date</label>
                                            <input type="text" class="form-control date date-picker" placeholder="Due Date">                                                                                                                          
                                        </div>
                                      </div>
                                            ...
                                            <div class="image-preview" style="padding-left: 0px;">
                                              <div id="image_preview" ></div>
                                                <span class="btn default btn-file btn-file-view">
                                                  <input type="file" class="profile-image btn-file-view"> </span>
                                            </div>
                                          </div>
                                      </div>
                                  </div>
