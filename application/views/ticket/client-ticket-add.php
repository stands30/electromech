    ...
    <div class="page-container">
              ...
              <div class="container-fluid container-wrap">
                  <div class="row">
                      <div class="col-md-12">
                        ...
                        <form id="ticket_add" method="post" class="horizontal-form">
                                      ...
                                      <div class="col-md-12">
                                        <div class="form-group">
                                           <label class="control-label">Description</label>
                                            <div class="">
                                              <textarea name="summernote" id="summernote_1" name="tck_desc" required ></textarea>
                                            </div>
                                            <div class="help-block"></div>
                                        </div>
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label class="control-label">Due Date</label>
                                            <input type="text" class="form-control date date-picker" id="tck_due_dt" name="tck_due_dt" placeholder="Due Date">
                                        </div>
                                        <div class="help-block"></div>
                                      </div>
      ...
      <div class="js-scripts">
       ...
       <script src="<?php echo base_url(); ?>assets/project/global/plugins/moment.min.js" type="text/javascript">
        ...
        <script src="<?php echo base_url(); ?>assets/module/ticket/js/ticket-add.js" type="text/javascript"></script>
