                      ...
                      <div class="table-responsive">
                        <table class="table" style="border:2px solid;border-style: ridge;    border-top: none;">
                          <tbody>
                              ...
                              <td rowspan="8">
                                ...
                                <?php
                                  if(isset($clientdata->cmp_logo) && $clientdata->cmp_logo != '')
                                    echo base_url().'assets/module/client/img/'.$clientdata->cmp_logo;
                                  else
                            ...
                            <tr>
                              <td>Client Type</td>
                              <td colspan="3"><?php if(isset($clientdata->cmp_type_name)) echo $clientdata->cmp_type_name; ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td colspan="3"><?php if(isset($clientdata->cmp_address)) echo $clientdata->cmp_address; ?></td>
                            </tr>
                            <tr>
                              <td>Payment Terms</td>
                              <td colspan="3"><?php if(isset($clientdata->cmp_payment_terms)) echo $clientdata->cmp_payment_terms; ?></td>
                            </tr>
                            <tr>
                              <td>Client Employees</td>
                              <td colspan="3"><?php if(isset($clientdata->cmp_employee)) echo $clientdata->cmp_employee; ?></td>
                            </tr>
                            <td>Client GST No</td>
                            <td ><?php if(isset($clientdata->cmp_gst_no)) echo $clientdata->cmp_gst_no; ?></td>
                            <td>Client Pan No</td>
                            <td ><?php if(isset($clientdata->cmp_pan)) echo $clientdata->cmp_pan; ?></td>
                          </tbody>
                        </table>
                      </div>
                    </div>
