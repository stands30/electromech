            ...
            <div class="row">
              ...
              <div class="container-fluid">
                <div class="text-center title_wrap mt-20">
                  <h3 class="page-title text-center">Edit Client People
                  </h3>
                  <span class="sp_line color-primary">
                  </span>
                </div>
                <form  role="form" id="cmp_ppl_edit" class="col-md-push-2 col-md-8 form_add">
                  <input type="hidden" name="cpl_id" id="cpl_id" value="<?php echo $clientPplDetail->cpl_id ?>">
                  <div class="form-group col-md-6">
                       <label>Client</label>
                        <select name="cpl_cmp_id" id="cpl_cmp_id"  class="form-control client_name" required>
                          <option value="<?php echo $clientPplDetail->cpl_cmp_id; ?>"><?php echo $clientPplDetail->cmp_name; ?></option>
                         </select>
                   ...
                   <!-- <input type="hidden" name="epl_id" id="epl_id" value=""> -->
                     <div class="form-group col-md-6">
                         ...
                         <select class="form-control client_people" id="cpl_ppl_id" name="cpl_ppl_id" required>
                           <option value="<?php echo $clientPplDetail->cpl_ppl_id; ?>"><?php echo $clientPplDetail->ppl_name; ?></option>
                         </select>
                         <div class="help-block">
                         </div>
                     </div>
                          ...
                          <div class="input-icon">
                            <i class="fas fa-id-card-alt"></i>
                              <select name="cpl_designation" id="cpl_designation" class="form-control cpl_designation custom-select2">
                               <option value="<?php echo $clientPplDetail->cpl_designation; ?>"><?php echo $clientPplDetail->cpl_designation_name; ?></option>
