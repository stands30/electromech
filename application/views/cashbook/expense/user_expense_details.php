      ...
      <div class="page-content">
        ...
        <div class="page-bar" id="breadcrumbs-list">
          ...
          <div class="breadcrumb-button">
              <a href="<?php echo base_url('user-expense-detail-'.$cashbook_details['prev_encrypt']) ?>" class=" previous" title="">
                  <button id="newlead" class="btn green">
                      <i class="fa fa-arrow-left"></i>
                      <!-- Previous  -->
                  </button>
              </a>
              <a href="<?php echo base_url('user-expense-detail-'.$cashbook_details['next_encrypt']) ?>" class="next">
                  <button id="newlead" class="btn green">
                    ...
                    <header class="panel-heading color-primary">
                      <div class="row detail-box">
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <span class="detail-list-heading">User Expense Details</span><br>
                          <span class="panel-title">
                          <?php echo $title; ?>
                          </span>&nbsp;&nbsp;
                          <a class="btn btn-edit" href="<?php echo base_url('user-expense-edit-'.$this->nextasy_url_encrypt->encrypt_openssl($cashbook_details['csb_id'])); ?>">
                          <i class="fa fa-edit">
                          </i>
                      ...
                      <table class="table table-detail-custom table-style">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo number_format($cashbook_details['csb_amount']); ?>
                            </td>
                          </tr>
                          <tr>
