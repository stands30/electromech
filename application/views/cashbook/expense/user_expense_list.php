                        ...
                        <!-- END PAGE HEADER-->
                                ...
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <div class="btn-group">
                                            <a id="sample_editable_1_new" href="<?php echo base_url('user-expense-add'); ?>" class="btn green"> Add Expense
                                ...
                                <div class="portlet-body">
                                	<form method="post" enctype="multipart/form-data" id="frmListing">
	                                    <table class="table table-striped table-bordered table-hover cashbook-list table-list" id="sample_1">
	                                        <thead>
	                                            <tr>
       ...
       <script src="<?php echo base_url(); ?>assets/project/sweetalert/dist/sweetalert.min.js" type="text/javascript"></script>
        ...
        <script type="text/javascript">
        	...
        	function getCashbooklist()
        	{
	            ...
	            var customDataTableUrl     =  baseUrl + 'getexpenselist?table_data_count='+customDataTableCount;
	            var customDataTableColumns = [
	             ...
	             {   'data'  : 'csb_particular' ,
	                ...
	                {
	                    link = `
	                           <a href="`+baseUrl+`user-expense-detail-`+row.csb_id_encrypt+`" title=" Detail View "> `+row.csb_particular+`</a>
	                          `;
	                  return link;
	                }
	              },
	              ...
	              {   'data'  : 'csb_id' ,
	                ...
	                {
	                    link = `
	                            <a href="`+baseUrl+`user-expense-edit-`+row.csb_id_encrypt+`" title="Edit Details ">
	                            ...
	                            <i style="font-size: 18px;" class="fa fa-trash" aria-hidden="true"></i></a>&nbsp;
	                          `;
	                  return link;
	                }
	              }
