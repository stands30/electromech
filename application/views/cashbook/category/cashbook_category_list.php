    ...
    <html lang="en">
                        ...
                        <!-- END PAGE HEADER-->
                                ...
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold">Cashbook Category List</span> &nbsp;
                                        <div class="btn-group">
                                                <a id="sample_editable_1_new" href="<?php echo base_url('cashbook-category-add'); ?>" class="btn green"> Add New
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover category-list" id="sample_1">
                                        <thead>
                                            <tr>
       ...
       <script src="<?php echo base_url(); ?>assets/project/sweetalert/dist/sweetalert.min.js" type="text/javascript"></script>
        ...
        <script type="text/javascript">
        	...
        	{
        		var customDataTableElement = '.category-list';
        		$(customDataTableElement).DataTable().destroy();
	            var customDataTableCount   = '<?php echo $dataTableData->table_data_count; ?>';
	            var customDataTableServer  = <?php echo $dataTableData->table_server_status; ?>;
	            var customDataTableUrl     =  baseUrl + 'getcashbook_categorylist?table_data_count='+customDataTableCount;
	            var customDataTableColumns = [
	              ...
	              {   'data'  : 'cbc_id_encrypt' ,
	                'render': function(data, type, row, meta)
	                {
	                  if(type === 'display'){
	                    link = `
	                            <a href="`+baseUrl+`cashbook-category-edit-`+row.cbc_id_encrypt+`" title="Edit Details ">
	                            <i style="font-size: 18px; color:#EF7F1A;" class="fa fa-edit" aria-hidden="true"></i></a>&nbsp;
	                             <a  onclick="deleteCategory('`+row.cbc_id_encrypt+`')" title="Delete Details ">
        	...
        	function deleteCategory(categoryid)
	        {
	          ...
	          {
	            type: "POST",
	            url: baseUrl + "cashbook-category-delete-"+categoryid,
