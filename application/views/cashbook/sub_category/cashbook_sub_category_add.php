            ...
            <div class="row">
              ...
              <div class="container-fluid">
                <div class="text-center title_wrap mt-20">
                  <h3 class="page-title text-center">Add New Sub Category
                  </h3>
                  <span class="sp_line color-primary">
                  </span>
                </div>
                <form role="form" class="col-md-push-2 col-md-8 form_add" id="sub_category_add">
                    <div class="row">
                      ...
                      <div class="form-group col-md-6 form-md-line-input form-md-floating-label">
                        ...
                        <div class="input-icon">
                          <input type="text" name="csc_name" id="csc_name" value="" class="form-control color-primary-light" required>
