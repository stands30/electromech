            ...
            <div class="row">
              ...
              <div class="container-fluid">
                <div class="text-center title_wrap mt-20">
                  <h3 class="page-title text-center">Add New Accounts
                  </h3>
                  <span class="sp_line color-primary">
                  </span>
                </div>
                <form role="form" class="col-md-push-2 col-md-8 form_add" id="account_add">
                    <div class="row">
                      <div class="form-group col-md-6 form-md-line-input form-md-floating-label">
                        <div class="input-icon">
                           <input type="text" name="acc_name" id="acc_name" value="" class="form-control color-primary-light" required>
                           <label>Account Name 
                      ...
                      <div class="form-group col-md-6 form-md-line-input form-md-floating-label">
                        ...
                        <textarea type="text" name="acc_desc" id="acc_desc" value="" class="form-control color-primary-light"  rows="2" required></textarea>
