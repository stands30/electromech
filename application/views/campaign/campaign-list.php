                        ...
                        <!-- END PAGE HEADER-->
                                ...
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <div  id="btn-box" class="btn-group">
                                            ...
                                            <a id="sample_editable_1_new" href="<?php echo base_url('campaign-add'); ?>" class="btn green"> Add Campaign
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-quot table-list" id="module-list">
                                        <thead>
                                            <tr>
                                                <th><i class="fas fa-handshake icon-client list-level"></i>Campaign Name</th>
                                                ...
                                                <th><i class="fa fa-calendar list-level"></i> End Date</th>
                                        ...
                                        <tbody>
                                          <tr>
                                              <td><a href="<?php echo base_url('campaign-details'); ?>">CRM</a></td>
