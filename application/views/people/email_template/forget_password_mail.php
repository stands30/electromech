    ...
    <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width="90%"
     ...
     <tr>
      ...
      padding:22.5pt 22.5pt 22.5pt 22.5pt'>
        <div>
          <h2><?php echo $data['project_name'].' reset confirmation'; ?></h2>
        ...
        style='font-size:10.5pt;font-family:"Lucida Sans","sans-serif";color:#222222'>
         Hi <strong><?php echo $data['people']->ppl_name.','; ?></strong>
        <br>
        <br>
        <p>You recently requested a link to reset your password.
        ...
        <p><?php echo $data['project_name'].' Team'; ?></p>
