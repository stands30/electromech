    ...
    <html lang="en">
        ...
        <head>
           ...
           <link href="<?php echo base_url(); ?>assets/project/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
            <link href="<?php echo base_url(); ?>assets/module/bsn-prm/css/sweetalert.css" rel="stylesheet" type="text/css" />
                                  ...
                                  <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">People tags</span>
                            ...
                            <form  id="bsn_edit">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          <label>Status<span style="color:red">*</span></label>
                                          <select id="bpm_status_e" name="bpm_status_e" class="form-control bpn_sts_edit" tabindex="-1" aria-hidden="true">
                                            <!-- <option value='1'>Active</option>
                                            <option value='2'>InActive</option> -->
      ...
      <script src="<?php echo base_url(); ?>assets/project/global/plugins/datatables/bootstrap/js/dataTables.bootstrap.min.js" type="text/javascript">
      ...
      <script src="<?php echo base_url(); ?>assets/module/bsn-prm/js/sweetalert.min.js" type="text/javascript"></script>
      <script src="<?php echo base_url(); ?>assets/module/bsn-prm/js/form-validation/bsn_prm.js" type="text/javascript"></script>
      <!-- OPTIONAL SCRIPTS -->
