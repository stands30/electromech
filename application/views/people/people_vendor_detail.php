    ...
    <html lang="en">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar" id="breadcrumbs-list">
                            <?php 
                            echo $breadcrumb; 
                            echo getPrevNextBtn('people-vendor-detail', $ppl_id); ?>
                        </div>
                        <!-- END PAGE BAR -->
                        <!-- END PAGE HEADER-->
                        <div class="portlet">
                                         ...
                                         <div class="portlet light table-bordered">
                                            <div class="portlet-title">
                                                <div class="caption font-dark">
                                                    ...
                                                    <span class="caption-subject bold">Vendor List</span> &nbsp;
                                                    <div class="btn-group">
                                            ...
                                            <div class="portlet-body">
                                                <table class="table table-striped table-bordered table-hover table-list people-list" id="tblVendorlist">
                                                      <thead>
                                                        <tr>
                                                            <th>Name</th>
                                                            <th>People Email</th>
         ...
         function getvendorlist()
        {
            ...
            var customDataTableElement = '#tblVendorlist';
            var customDataTableCount   = '<?php echo $dataTableData->table_data_count; ?>';
            var customDataTableServer  = <?php echo $dataTableData->table_server_status; ?>;
            var customDataTableUrl     =  baseUrl + 'people-vendor-getlist-'+ppl_id+'?table_data_count='+customDataTableCount;
