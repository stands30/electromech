    ...
    <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width="90%"
     ...
     <tr>
      ...
      padding:22.5pt 22.5pt 22.5pt 22.5pt'>
        <div>
          <p class=MsoNormal style='margin-bottom:12.0pt;line-height:18.0pt'>
            <span style='font-size:10.5pt;font-family:"Lucida Sans","sans-serif";color:#222222'>
              <p>Follow Up Email</p>
              <p>Dear <strong><?php echo $data['led_ppl_name']; ?></strong>,</p><br />
              <p>Greeting From <?php if(!empty($data['company_name'])) echo $data['company_name']; ?></p>
              <?php echo '<p>'.$data['lfp_instruction'].'</p>'; ?>
              <div><br />
                Remark : 
                <?php echo '<p>'.$data['lfp_remark'].'</p>'; ?>
                <br />
              </div>
              <p>Thanks & Regards
              <br />
              - Powered By Easynow.App</p>
            </span>
          </p>
        </div>
      </td>
