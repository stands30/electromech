          ...
          <div class="portlet light bordered">
            ...
            <div class="portlet-title">
              <div class="caption font-dark">
                ...
                <span class="caption-subject bold uppercase">Master Process List
                </span> &nbsp;
                <div class="btn-group">
                  <a id="sample_editable_1_new" href="<?php echo base_url('master-process-add'); ?>" class="btn green">Initiate Process
                    <!-- <i class="fa fa-plus">
                    </i> -->
                  </a>
                </div>
              ...
              <table class="table table-striped table-bordered table-hover" id="sample_1">
                <thead>
                  <tr>
                    ...
                    <th><i class="fas fa-user list-level"></i>Created By
                    </th>
                    <th><i class="fas fa-calendar-alt list-level"></i> Created On 
                    </th>
                ...
                <tbody>
                  <tr>
                   <td> <a href="<?php echo base_url('master-process-detail'); ?>">New Process Module</a></td>
                    <td> John Carlino 
                    </td>
                    <td> 03/08/2018
                    </td>
                    <td>
                   <!--    <a href="<?php echo base_url('master-process-detail'); ?>" title="View Detail">
