          ...
          <div class="portlet light bordered">
            <div class="portlet-title">
              <div class="caption font-dark">
                ...
                <span class="caption-subject bold">Company / Account List
                </span> &nbsp;
                <div class="btn-group">
                  <?php if($add_access) {?>
    ...
    <div class="js-scripts">
      ...
      <script type="text/javascript">
        ...
        function getCompanyList()
        {
          ...
          var customDataTableUrl     =  baseUrl + 'company-getlist?table_data_count='+customDataTableCount;
          var customDataTableColumns = [
              ...
              {   'data'  : 'cmp_id' ,
                'render': function(data, type, row, meta)
                {
                  ...
                  <?php if($edit_access) { ?>
                    link += '<a href="'+baseUrl+'company-edit-'+row.cmp_id_encrypt+'" title="Edit Company "><i class="fa fa-edit" aria-hidden="true"></i></a>';
