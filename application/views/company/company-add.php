  ...
  <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
    ...
    <div class="page-container">
            ...
            <div class="row">
              ...
              <div class="container-fluid">
                <div class="text-center title_wrap mt-20">
                  <h3 class="page-title text-center">Add New Company</h3>
                ...
                <form role="form" id="company_add" class="col-md-push-2 col-md-8 form_add">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group form-md-line-input form-md-floating-label">
                        ...
                        <label for="cmp_name">Company Name
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group form-md-line-input form-md-floating-label">
                        <div class="input-icon input-label-text">
                          <input type="url" name="cmp_youtube" id="cmp_youtube" class="form-control  color-primary-light">
      ...
      <div class="js-scripts">
        ...
        <script src="<?php echo base_url(); ?>assets/module/company/js/form-validation/company_add.js<?php echo $global_asset_version; ?>" type="text/javascript"></script>
