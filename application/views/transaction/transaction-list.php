                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                <table class="table table-striped table-bordered table-hover table-quot table-list" id="module-list">
                                    <thead>
                                        <tr>
                                            <th><i class="fas fa-rss list-level"></i> Subscription Id</th>
                                            <th><i class="fas fa-clipboard-list list-level"></i> Plan</th>
                                            ...
                                            <th><i class="far fa-money-bill-alt icon-lead list-level"></i>Price</th>
                                            <th><i class="far fa-money-bill-alt icon-lead list-level"></i>Currency</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" title="View Details ">
                                                    <i style="font-size: 15px; color:#EF7F1A;" class="fa fa-book" aria-hidden="true"></i>
                                                </a>
                                                <a href="#" title="Delete ">
