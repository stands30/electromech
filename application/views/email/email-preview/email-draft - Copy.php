                    ...
                    <div class="col-md-10 half-side-padding">
                        <div class="inbox-body">
                            <div class="inbox-header">
                                <h1 class="pull-left page-title">Draft</h1>
                            ...
                            <div class="inbox-content">
                                <table class="table table-striped table-advance table-hover table-email-sent">
                                    <thead>
                                        <tr>
                                            <th colspan="3">
                                                ...
                                                <div class="btn-group input-actions before-list">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-draft-list">
                                                        <li>
                                                            <a href="javascript:;">
                                                                <i class="fas fa-envelope-open list-level"></i> Mark as Read </a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:;">
                                                                <i class="fas fa-trash list-level"></i> Delete </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                

                                                <a href="#" id="draft-delete" class="draft-delete after-list hidden">Discard Drafts</a>
                                            ...
                                            <th class="pagination-control" colspan="3">
                                                <span class="pagination-info"> 1-19 of 789 </span>
                                                <a class="btn btn-sm blue green btn-outline page-view">
                                    ...
                                    <tbody>
                                        <tr data-messageid="1">
                                            ...
                                            <td class="view-message hidden-xs"><span class="draft-name">Draft</span></td>
                                            <td class="view-message ">(no subject)</td>
                                        ...
                                        <tr data-messageid="3">
                                            ...
                                            <td class="view-message hidden-xs"> John Doe <span class="draft-name">Draft</span> </td>
                                        ...
                                        <tr data-messageid="12">
                                            ...
                                            <td class="hidden-xs"> <span class="draft-name">Draft</span> </td>
                                            <td class="view-message"> Dolor sit amet, consectetuer adipiscing </td>
                                            <td class="view-message inbox-small-cells">
                                                <i class="fa fa-paperclip"></i>
                                            </td>
