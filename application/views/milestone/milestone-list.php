                        ...
                        <!-- END PAGE HEADER-->
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold">Milestone</span> &nbsp;

                                        <div id="btn-box" class="btn-group">

                                            <a href="<?php echo base_url('milestone-add'); ?>" class="btn green"> Add Milestone
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-quot table-list " id="module-list">
                                        ...
                                        <thead>
                                            ...
                                            <tr><!-- 
                                                ...
                                                <th><i class="fas fa-users list-level"></i>Team</th>
                                                <th><i class="fas fa-th-list list-level"></i>Status</th>
                                                <th><i class="fas fa-th-list list-level"></i>Project</th>
                                               ...
                                               <th><i class="fas fa-cog list-level"></i> Action </th> -->
                                                ...
                                                <th><i class="fas fa-project-diagram list-level"></i>Project</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td ><a href="<?php echo base_url('milestone-details'); ?>"details>Milestone Details</a></td>
                                                 <td>pooja</td>
                                                 <td>Pending</td>
                                                 <td>Easy now</td>
                                                 <td>Pooja</td>
