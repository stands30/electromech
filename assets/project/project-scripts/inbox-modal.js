// var AppModalInbox = function () {

//     var content = $('.inbox-modal-compose');
...
//         var the = $('.inbox-modal-compose .mail-to .inbox-modal-cc');
//         var input = $('.inbox-modal-compose .input-modal-cc');
//         the.hide();
//         input.show();
...
//         var the = $('.inbox-modal-compose .mail-to .inbox-modal-bcc');
//         var input = $('.inbox-modal-compose .input-bcc');
//         the.hide();
//         input.show();
//         $('.close', input).click(function () {
//             input.hide();
...
//             // handle view message
//             $('.inbox-modal-compose').on('click', '.view-message', function () {
//                 loadMessage($(this));
//             });
...
//             // $('.inbox-modal-compose').on('click', '.mail-to .inbox-modal-cc', function () {
//             //     console.log("here");
//             //     handleCCInput();
//             // });

//             //handle compose/reply bcc input toggle
//             // $('.inbox-modal-compose').on('click', '.mail-to .inbox-modal-bcc', function () {
//             //     console.log("here");
//             //     handleBCCInput();
//             // });
...
var handleBCCInput = function () {
    var the = $('.inbox-modal-compose .mail-to .inbox-modal-bcc');
    var input = $('.inbox-modal-compose .input-modal-bcc');
    the.hide();
    input.show();
    $('.close', input).click(function () {
        input.hide();
