...
$('.sub-category-select2').empty();
 $('.sub-category-select2').select2({
    ...
    placeholder:"Select Sub Category",
     ajax: 
        {
          url: baseUrl+'income/getSubCategoryforDropdown/'+category_id,
          dataType: 'json',
        }
    });
}
...
$(document).ready(function(){
  ...
  var select2url = baseUrl+'income/getGenPrmforDropdown/';
 ...
 $('.category-select2').select2({
    ...
    placeholder:"Select Category",
     ajax: 
        {
          url: baseUrl+'income/getCategoryforDropdown',
          dataType: 'json',
        }
    });
...
$('.people-select2').select2({
    ...
    placeholder:"Select Person",
     ajax: 
        {
          url: baseUrl+'income/getPersonforDropdown',
          dataType: 'json',
        }
    });
...
$('.account-select2').select2({
    ...
    placeholder:"Select Account",
     ajax: 
        {
          url: baseUrl+'income/getAccountforDropdown',
          dataType: 'json',
        }
    });
    ...
    submitHandler: function(form) 
    {
      try
      {
        ...
        $.ajax({
          ...
          type: "POST",
                  url: baseUrl + "income/insertIncome",
                  data : formData,
                  dataType:"json",
    ...
    submitHandler: function(form) 
    {
      try
      {
        ...
        $.ajax({
          ...
          type: "POST",
                  url: baseUrl + "income/updateIncome",
                  data : formData,
                  dataType:"json",
                  contentType: false,       // The content type used when sending data to the server.
                  cache: false,             // To unable request pages to be cached
