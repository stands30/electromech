   ...
   $("#expense_add").validate({
    ...
    submitHandler: function(form) 
    {
      try
      {
        ...
        var csb_transaction_type= document.getElementById("csb_transaction_type").value;
        ...
        formData.append("csb_transaction_type",csb_transaction_type);
        ...
        $.ajax({
          ...
          type: "POST",
                  url: baseUrl + "expense/insertUserExpense",
                  data : formData,
                  dataType:"json",
    ...
    submitHandler: function(form) 
    {
      try
      {
        ...
        $.ajax({
          ...
          type: "POST",
                  url: baseUrl + "expense/updateUserExpense",
                  data : formData,
                  dataType:"json",
                  contentType: false,       // The content type used when sending data to the server.
                  cache: false,             // To unable request pages to be cached
